...
class LinkedListRemoveLastNodeTest {

    @Test
    void removeLastNode_FromLinkedList_WithZeroElement() {
    ...
    @Test
    void removeLastNode_FromLinkedList_WithOneElement() {
    ...
    @Test
    void removeLastNode_FromLinkedList_WithMultipleElements() {
        LinkedList linkedList = new LinkedList(5);
